export const fgosLessonStages = {
  ...
  actualization: {
    title: "🔄 1.1 Актуализация знаний",
    duration: "8 минут",
    pedagogicalGoal:
      "Повторение ранее изученного материала и подготовка к восприятию новых знаний",
    activities: [
      {
        ...
        gameElement:
          "⚡ Lightning Master: самая длинная цепочка предметов = +10 баллов",
      },
      {
        ...
        gameElement:
          "🔮 Mystery Solver: правильная догадка с полным описанием = +5 баллов",
      },
      {
  ...
  "physical-break": {
    title: "🤸‍♀️ Физкультминутка - Школьный Модный Показ",
    duration: "3 минуты",
    pedagogicalGoal: "Физическая разрядка и закрепление лексики через движения",
    activities: [
      {
      ...
      },
      {
        ...
        gameElement:
          "🎭 Best Actor: самое выразительное изображение предмета = +3 балла",
      },
    ],
  },
  "primary-check": {
  ...
  application: {
    ...
    duration: "12 минут",
    pedagogicalGoal:
      "Практическое применение новых знаний в различных ситуациях",
    activities: [
      {
      ...
      },
      {
        ...
        gameElement:
          "✉️ Email Pro: самое интересное письмо с использованием всех новых слов = +15 баллов",
      },
      {
