...
const LessonPlan = () => {
  ...
  const lessonData = {
    ...
    materials: {
      title: "📋 Материалы и источники урока",
      textbooks: [
        {
          title: "Spotlight 8. Student's Book",
          authors: "Ваулина Ю.Е., Дули Д., Подоляко О.Е., Эванс В.",
          publisher: "Просвещение",
          year: "2023",
          pages: "42-43",
          isbn: "978-5-09-088234-5",
          description:
            "Основной учебник для изучения школьной лексики и грамматических конструкций",
        },
        {
          title: "Spotlight 8. Workbook",
          authors: "Ваулина Ю.Е., Дули Д., Подоляко О.Е., Эванс В.",
          publisher: "Просвещение",
          year: "2023",
          pages: "28-29",
          isbn: "978-5-09-088235-2",
          description:
            "Рабочая тетрадь для закрепления материала и домашней работы",
        },
      ],
      audioVisual: [
        {
          title: "Spotlight 8. Class Audio CDs",
          type: "Аудиоматериалы",
          publisher: "Просвещение",
          year: "2023",
          description:
            "Аудиозаписи для отработки произношения и восприятия речи на слух",
        },
        {
          title: "Interactive Whiteboard Software",
          type: "Программное обеспечение",
          description:
            "Интерактивные задания и презентации для работы с доской",
        },
      ],
      digitalResources: [
        {
          title: "Quizlet - School Subjects Vocabulary",
          url: "https://quizlet.com",
          type: "Образовательная платформа",
          description:
            "Интерактивные карточки для изучения лексики по школьным предметам",
        },
        {
          title: "Padlet - Collaborative Timeline Board",
          url: "https://padlet.com",
          type: "Цифровая доска",
          description: "Совместная работа над проектами и обмен идеями",
        },
        {
          title: "Kahoot! - Grammar Quiz Platform",
          url: "https://kahoot.com",
          type: "Игровая платформа",
          description: "Интерактивные викторины для проверки знаний грамматики",
        },
      ],
      didacticMaterials: [
        {
          title: "Карточки с новой лексикой",
          type: "Дидактический материал",
          description:
            "Самостоятельно изготовленные карточки со словами по теме 'School Life'",
        },
        {
          title: "Timeline Templates",
          type: "Раздаточный материал",
          description:
            "Шаблоны для создания временных линий и хронологии событий",
        },
        {
          title: "Grammar Reference Cards",
          type: "Справочный материал",
          description:
            "Карточки-помощники с правилами употребления прошедших времен",
        },
        {
          title: "Assessment Rubrics",
          type: "Оценочный материал",
          description:
            "Критерии оценивания для взаимооценки и самооценки учащихся",
        },
      ],
      methodicalSources: [
        {
          ...
          year: "2021",
          description:
            "Основа для планирования урока и определения образовательных результатов",
        },
        {
          title:
            "Примерная рабочая программа основного общего образования. Иностранный (английский) язык",
          authors: "Министерство просвещения РФ",
          year: "2021",
          description:
            "Методические рекомендации по преподаванию английского языка",
        },
        {
          title: "Геймификация в образовании: методические рекомендации",
          authors: "Варенина Л.П., Ширкова Н.Н.",
          publisher: "Педагогический университет",
          year: "2022",
          description:
            "Методическая основа для применения игровых элементов в обучении",
        },
      ],
    },
  };
