...
const LessonPlan = () => {
  ...
  const lessonData = {
    ...
    objectives: {
      practical: [
        "Освоить и активизировать 16 лексических единиц по теме 'School Life' (attend, boarding school, co-educational, facility, scholarship, uniform и др.) с достижением 85% понимания при восприятии и 75% воспроизведения в речи",
        "Сформировать навыки употребления Past Perfect и Past Perfect Continuous для выражения предшествования в прошлом с точностью выполнения 80% в коммуникативных ситуациях",
        "Развить умения монологической речи: построение связного высказывания (6-8 предложений) о школьном опыте с использованием изученной лексики и грамматических структур",
        "Совершенствовать умения поискового чтения аутентичных текстов образовательной тематики с извлечением 80% запрашиваемой информации",
        "Развить умения аудирования с пониманием основного содержания (80%) и детальной информации (65%) в аудиотекстах продолжительностью 2-3 минуты",
      ],
      developing: [
        "Регулятивные УУД: формировать умения целеполагания и планирования учебных действий, осуществлять контроль и коррекцию речевой деятельности, оценивать результаты индивидуальной и групповой работы",
        "Познавательные УУД: развивать смысловое чтение с извлечением и интерпретацией информации, логические операции анализа и синтеза при работе с грамматическими структурами, использование знаково-символических средств для систематизации языкового материала",
        "Коммуникативные УУД: совершенствовать навыки сотрудничества в парной и групповой работе, развивать умения планировать учебное сотрудничество, формулировать и аргументировать свою точку зрения на изучаемом языке",
      ],
      upbringing: [
        "Формировать ценностное отношение к образованию как основе личностного развития и успешной социализации",
        "Воспитывать уважительное отношение к образовательным традициям и культуре стран изучаемого языка, развивать межкультурную толерантность",
        "Развивать мотивацию к изучению иностранного языка как средства межкультурного общения и самореализации в поликультурном мире",
        "Формировать ответственное отношение к учению, готовность к саморазвитию и самообразованию",
        "Воспитывать культуру общения и сотрудничества в процессе парной и групповой деятельности",
      ],
    },
    plannedResults: {
      subject: {
