...
const LessonPlan = () => {
  ...
  const lessonData = {
    ...
    duration: "45 минут",
    goal: "Создание условий для формирования у обучающихся 8 класса коммуникативной компетенции в области «Школьная жизнь» посредством освоения тематической лексики (16 лексических единиц) и системы прошедших времен английского языка (Past Perfect, Past Perfect Continuous) в контексте описания школьного опыта",
    objectives: {
      practical: [
        "Обеспечить усвоение и первичное закрепление 16 лексических единиц тематической группы 'School Life' (attend, boarding school, co-educational, facility, scholarship, uniform, extra-curricular, participate и др.) с уровнем понимания 90% и воспроизведения 70%",
        "Сформировать навык распознавания и употребления Past Perfect и Past Perfect Continuous в речевых ситуациях описания школьных событий с точностью 80% при выполнении коммуникативных заданий",
        "Развить умение построения связного монологического высказывания (5-7 предложений) о школьном опыте с использованием освоенной лексики и грамматических структур",
        "Совершенствовать навыки поискового чтения аутентичных текстов о системах образования с извлечением 85% ключевой информации",
        "Развить навыки аудирования с пониманием основного содержания (75%) и детальной информации (60%) в контексте школьной тематики длительностью до 3 минут",
      ],
      developing: [
        "Развивать регулятивные УУД: целеполагание (формулирование учебных задач), планирование последовательности действий в квест-заданиях, контроль правильности выполнения грамматических конструкций, коррекция речевых ошибок на основе обратной связи, оценка результатов индивидуальной и командной деятельности",
        "Формировать познавательные УУД: смысловое чтение с извлечением и преобразованием информации, логический анализ грамматических структур, синтез при создании временных последовательностей, построение логической цепи рассуждений при сравнении образовательных систем",
        "Совершенствовать коммуникативные УУД: планирование учебного сотрудничества в команде (распределение ролей), управление поведением партнера в групповой работе, умение с достаточной полнотой выражать свои мысли на английском языке, владение диалогической и монологической речью",
        "Развивать общеучебные умения: работа с различными источниками информации, использование знаково-символических средств (схемы, таблицы) для систематизации грамматического материала, применение ИКТ-технологий для поиска и обработки информации",
      ],
      upbringing: [
        "Воспитывать ценностное отношение к образованию как основе личностного и профессионального развития через анализ различных образовательных возможностей",
        "Формировать толерантность и уважение к образовательным традициям разных стран, готовность к межкультурному диалогу на основе взаимного уважения",
        "Развивать ответственное отношение к учению, готовность и способность к саморазвитию и самообразованию на основе мотивации к обучению и познанию",
        "Воспитывать коммуникативную компетентность в общении и сотрудничестве со сверстниками, формировать навыки командной работы и взаимопомощи",
        "Формировать мотивацию к изучению иностранного языка как средства расширения возможностей самореализации и социальной адаптации в современном поликультурном мире",
      ],
    },
    plannedResults: {
      subject: {
