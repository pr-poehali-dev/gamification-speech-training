...
const LessonPlan = () => {
  ...
  const lessonData = {
    ...
    duration: "45 минут",
    goal: "Формирование коммуникативной компетенции учащихся через освоение лексико-грамматического материала по теме «Школьная жизнь» и совершенствование навыков использования прошедших времен английского языка в контексте описания школьного опыта",
    objectives: {
      educational: [
        "Обеспечить усвоение учащимися лексических единиц по теме 'School Life' (attend, boarding school, co-educational, facility, scholarship, uniform и др.)",
        "Сформировать умения различать и правильно употреблять Past Perfect, Past Perfect Continuous, Past Simple, Past Continuous",
        "Развить навыки построения связных высказываний о школьной жизни с использованием изученных грамматических структур",
        "Совершенствовать навыки аудирования и чтения аутентичных текстов по теме урока",
      ],
      developing: [
        "Развивать коммуникативные универсальные учебные действия через парную и групповую работу",
        "Формировать регулятивные УУД: целеполагание, планирование, контроль и коррекция",
        "Развивать познавательные УУД: анализ, синтез, сравнение языковых явлений",
        "Совершенствовать критическое мышление через решение проблемных квест-заданий",
        "Развивать память, внимание и логическое мышление",
      ],
      upbringing: [
        "Воспитывать положительное отношение к процессу изучения иностранного языка",
        "Формировать уважительное отношение к образованию и школьной жизни",
        "Развивать толерантность и понимание особенностей школьных систем разных стран",
        "Воспитывать ответственность за результаты индивидуальной и коллективной деятельности",
        "Формировать мотивацию к самообразованию и саморазвитию",
      ],
    },
    plannedResults: {
      subject: {
