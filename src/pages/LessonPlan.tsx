...
const LessonPlan = () => {
  ...
  const lessonData = {
    ...
    duration: "45 минут",
    goal: "Создание условий для формирования коммуникативной компетенции учащихся через освоение лексико-грамматического материала по теме «Школьная жизнь» и развитие навыков использования системы прошедших времен английского языка в речевых ситуациях",
    objectives: {
      practical: [
        "Обеспечить освоение и активизацию лексических единиц по теме 'School Life': attend, boarding school, co-educational, facility, scholarship, uniform, extra-curricular, participate",
        "Сформировать практические навыки употребления Past Perfect и Past Perfect Continuous в сопоставлении с Past Simple и Past Continuous",
        "Развить умения построения монологических и диалогических высказываний о школьном опыте с использованием изученных временных форм",
        "Совершенствовать навыки поискового и изучающего чтения аутентичных текстов о системах образования",
        "Развить навыки аудирования с пониманием основного содержания и детальной информации",
      ],
      developing: [
        "Развивать коммуникативные УУД: планирование учебного сотрудничества, управление поведением партнера, умение выражать свои мысли",
        "Формировать регулятивные УУД: целеполагание, планирование, прогнозирование, контроль, коррекция, оценка, саморегуляция",
        "Развивать познавательные УУД: смысловое чтение, поиск и выделение информации, анализ и синтез, построение логической цепи рассуждений",
        "Совершенствовать языковую догадку и развивать механизмы памяти через контекстуальное запоминание лексики",
        "Развивать критическое мышление через анализ и сравнение образовательных систем разных стран",
      ],
      upbringing: [
        "Воспитывать ценностное отношение к образованию как основе успешной жизнедеятельности",
        "Формировать толерантность и уважение к различным образовательным традициям и культурам",
        "Развивать ответственное отношение к учению, готовность и способность к саморазвитию",
        "Воспитывать коммуникативную компетентность в общении и сотрудничестве со сверстниками",
        "Формировать мотивацию к изучению иностранного языка как средства расширения возможностей самореализации",
      ],
    },
    plannedResults: {
      subject: {
