    ...
    plannedResults: {
      subject: {
        ...
        items: [
          ...
          "Ученик научится различать и правильно употреблять времена Past Simple, Past Continuous, Past Perfect в контексте школьной жизни",
          "Ученик научится составлять связные высказывания о школьном расписании и учебных предметах с использованием изученной лексики",
          "Ученик научится понимать на слух основное содержание текстов о школьной жизни и извлекать необходимую информацию",
          "Ученик научится читать и понимать тексты о системе образования с полным пониманием содержания",
      ...
      metasubject: {
        ...
        regulatory: [
          ...
          "Ученик научится соотносить свои действия с планируемыми результатами и корректировать их",
          "Ученик научится оценивать правильность выполнения учебной задачи и собственные возможности её решения",
          "Ученик научится владеть основами самоконтроля и самооценки при выполнении заданий",
        ],
        cognitive: [
          "Ученик научится определять понятия, создавать обобщения, устанавливать аналогии при работе с лексикой",
          "Ученик научится классифицировать и выбирать основания для классификации школьных предметов",
          "Ученик научится строить логическое рассуждение и делать выводы при анализе временных форм",
          "Ученик научится создавать и применять знаково-символические средства для решения учебных задач",
        ],
        communicative: [
          "Ученик научится организовывать учебное сотрудничество и совместную деятельность в команде",
          "Ученик научится работать индивидуально и в группе, находить общее решение",
          "Ученик научится формулировать, аргументировать и отстаивать своё мнение о школьных предметах",
          "Ученик научится осознанно использовать речевые средства для выражения своих мыслей и потребностей",
        ],
      },
      personal: {
        ...
        items: [
          ...
          "Формирование осознанного, уважительного отношения к образованию как ценности",
          "Развитие навыков сотрудничества со сверстниками в образовательной деятельности",
          "Формирование коммуникативной компетентности в общении на английском языке",
          "Развитие эстетического сознания через освоение творческой деятельности",
          "Воспитание российской гражданской идентичности через сравнение образовательных систем",
        ],
      },
    },
  };
